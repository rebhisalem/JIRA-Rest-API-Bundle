...
/**
 * REST controller for managing {@link fr.magnolia.dsi.productmanager.domain.SurveyQuestion}.
 */
@RestController
@RequestMapping("/api")
public class SurveyQuestionResource {
    ...
    private static final String ENTITY_NAME = "productmanagerSurveyQuestion";
    ...
    public ResponseEntity<SurveyQuestion> getSurveyQuestion(@PathVariable String id) {

...
@Configuration
@EnableMongoRepositories("fr.magnolia.dsi.insurancepartnersgateway.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("fr.magnolia.dsi.insurancepartnersgateway.config.dbmigrations");
